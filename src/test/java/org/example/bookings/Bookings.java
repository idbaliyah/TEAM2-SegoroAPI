...
public class Bookings {
    ...
    public static String BOOKING_USER = ALL_BOOKINGS + "/{user_ID}";

    public static String ADD_CART = ALL_BOOKINGS + "/addtocart";

    public static String ADD_PAYMENT = ALL_BOOKINGS + "/bookings/{booking_id}/payment";

    public static String DELETE_BOOKING = ALL_BOOKINGS + "/{booking_id}";
